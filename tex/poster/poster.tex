...
\begin{document}
    ...
    \begin{columns}
        ...
        \block[bodyoffsety=0.7cm]{}{
            \setlength{\parindent}{1em}
            \input{components/base_model2.tex}
        }

        \block[bodyoffsety=0.7cm]{Single cluster}{
            \setlength{\parindent}{1em}
            \input{components/single_cluster.tex}
        }
        ...
        \block{}{
            \setlength{\parindent}{1em}
            \input{components/monochr.tex}
        }

        \block[bodyoffsety=0.7cm]{Wavepacket scattering}{
            \setlength{\parindent}{1em}
            \input{components/wavepacket.tex}
        }
