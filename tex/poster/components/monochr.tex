\begin{tikzfigure}
    \subcaptionbox{$\lambda = \lambda_{L} = 830$ nm.}{
        \includegraphics[width=0.45\linewidth]{../components/img/celes/Es_20nm_15deg_1harm.pdf}
    }
    \hfil
    \subcaptionbox{$\lambda = \lambda_{10} = 83$ nm.}{
        \includegraphics[width=0.45\linewidth]{../components/img/celes/Es_20nm_15deg_10harm.pdf}
    }
    \\
    \subcaptionbox{(\ref{bragg_wolf_order_spherical}) solution in integer Miller indices.}{
        \includegraphics[width=0.38\linewidth]{../components/img/celes/dphi_dtheta_kprime_d_2l_phi0_0_theta0_15.pdf}
    }
    \hfil
...
\begin{tikzfigure}
    \subcaptionbox{Impact of the target irregularity.}{
        \includegraphics[width=0.48\linewidth]{../components/img/celes/energy_vs_nonreg}
    }
    \hfil
    \subcaptionbox{Impact of the cluster radius, values normalized to $E_{\textrm{int}}$ at $a = 20$ nm.}{
        \includegraphics[width=0.48\linewidth]{../components/img/celes/energy_vs_radius}
    }
