...
\begin{figure}[H]
    \subimgtwo[components/img/celes/mean_field_0_42_1harm]{$\lambda = \lambda_{L} = 830$ nm.}{random_ka0.7:a}{0.4\textwidth}
    \subimgtwo[components/img/celes/check20_rad]{ $\lambda = \lambda_{10} = 83$ nm.}{random_ka0.7:b}{0.4\textwidth}
...
Рассмотрим влияние нерегулярности решетки на наиболее интенсивные направления рассеянного поля, то есть зависимость \autoref{e_int} от нерегулярности решётки $\eta$. Для этого смоделировано рассеяние в случае квазирегулярной решётки при различных параметрах и нерегулярностью $\eta$ от 0 до 0.5 (\Autoref{nonreg_mono:image, nonreg_ka0.7:image}).
    ...
    \begin{figure}[H]
        \subimgtwo[components/img/celes/mean_field_0_42]{$\eta = 0.09$.}{nonreg_ka0.7:a}{0.4\textwidth}
        \subimgtwo[components/img/celes/check20_rad]{ $\eta = 0$.}{nonreg_ka0.7:b}{0.4\textwidth}
