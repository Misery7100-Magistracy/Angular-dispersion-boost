...
\subsubsection{Рассеяние волнового пакета}
    ...
    \begin{figure}[ht]
        \subimgtwo[components/img/celes/e_int_wavepacket8..12_rad_20nm_15deg]{$\Delta \theta \in \left[ 0,\:\cfrac{\pi}{2} \right]$, $\theta_0 = 15^\circ$.}{wavepacket1:a}{0.45\textwidth}
        \hfil
        % \subimgtwo[components/img/celes/e_int_wavepacket8..12_rad_20nm_20deg]{$\Delta \theta \in \left[ \cfrac{\pi}{2},\:\pi \right]$, $\theta_0 = 20^\circ$.}{1st_check_diffrth:b}{0.45\textwidth}
        \\
        \subimgtwo[components/img/celes/wavepacket8..12_rad]{Амплитуда элементов гауссова волнового пакета напряженности поля в зависимости от длины волны.}{wavepacket1:c}{0.45\textwidth}
