...
Используя \autoref{bragg_wolf_sol_0}, можно построить решения, соответствующие целым значениям $l^\prime$, которые отвечают различным порядкам прошедшего и отраженного излучения (\autoref{phi0_theta0_lprime:image}).
    ...
    \begin{figure}[ht]
        \subimgtwo[components/img/celes/dphi_dtheta_kprime_d_2l_phi0_0_theta0_15]{$\Delta \theta \in \left[ 0,\:\cfrac{\pi}{2} \right]$.}{1st_check_diffrth:a}{0.4\textwidth}
        \hfil
        \subimgtwo[components/img/celes/e_int_cylinder_15edge_theta0_15_phi0_0_166gap]{$\Delta \theta \in \left[ 0,\:\cfrac{\pi}{2} \right]$.}{1st_check_diffrth:b}{0.5\textwidth}
        \subimgtwo[components/img/celes/dphi_dtheta_kprime_d_2l_phi0_0_theta0_15_refr]{$\Delta \theta \in \left[ \cfrac{\pi}{2},\:\pi \right]$.}{1st_check_diffrth:c}{0.4\textwidth}
        \hfil
        \subimgtwo[components/img/celes/e_int_cylinder_15edge_theta0_15_phi0_0_166gap_refr]{$\Delta \theta \in \left[ \cfrac{\pi}{2},\:\pi \right]$.}{1st_check_diffrth:d}{0.5\textwidth}
